...
:root { 
  ...
  --close-icon-light: url("data:image/svg+xml,<svg version='1.1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path style='fill:%23${jsonTokens.color.white};' d='M14.4,12l8.5-8.5c0.6-0.6,0.6-1.6,0-2.2s-1.6-0.6-2.2,0l-8.5,8.5L3.6,1.3C3,0.7,2.1,0.7,1.5,1.3c-0.6,0.6-0.6,1.6,0,2.2L10,12l-8.5,8.5c-0.6,0.6-0.6,1.6,0,2.2c0.3,0.3,0.7,0.4,1.1,0.4s0.8-0.1,1.1-0.4l8.5-8.5l8.5,8.5c0.3,0.3,0.7,0.4,1.1,0.4s0.8-0.1,1.1-0.4c0.6-0.6,0.6-1.6,0-2.2L14.4,12z'/></svg>");
  --close-icon-dark: url("data:image/svg+xml,<svg version='1.1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path style='fill:%23${jsonTokens.color.brand_primary};' d='M14.4,12l8.5-8.5c0.6-0.6,0.6-1.6,0-2.2s-1.6-0.6-2.2,0l-8.5,8.5L3.6,1.3C3,0.7,2.1,0.7,1.5,1.3c-0.6,0.6-0.6,1.6,0,2.2L10,12l-8.5,8.5c-0.6,0.6-0.6,1.6,0,2.2c0.3,0.3,0.7,0.4,1.1,0.4s0.8-0.1,1.1-0.4l8.5-8.5l8.5,8.5c0.3,0.3,0.7,0.4,1.1,0.4s0.8-0.1,1.1-0.4c0.6-0.6,0.6-1.6,0-2.2L14.4,12z'/></svg>");
  }`;
