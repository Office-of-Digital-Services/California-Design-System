...
class NavMenu extends HTMLElement {
  connectedCallback() {
    ...
    window.setTimeout(() => {
      ...
      if (menuLabel !== null) {
        ...
        this.button.innerHTML = `<span>${menuLabel.innerHTML}</span><ca-icon symbol="right"></ca-icon>`;
  ...
  open() {
    ...
    menuButtonIcon.setAttribute("symbol", "close");
  }
  ...
  close() {
    ...
    buttonIcon.setAttribute("symbol", "right");
  }
